 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/Server/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://server/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Server/Service?wsdl");
    ...
    public service.Service getServicePort() {
        return super.getPort(new QName("http://server/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public service.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "ServicePort"), Service.class, features);
    }
